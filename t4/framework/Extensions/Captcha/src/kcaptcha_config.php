...
$alphabet = "0123456789acdefghijklmnoprstuvwxyz"; # do not change without changing font files!

# symbols used to draw CAPTCHA
//$allowed_symbols = "0123456789"; #digits
//$allowed_symbols = "23456789abcdegkmnpqsuvxyz"; #alphabet without similar symbols (o=0, 1=l, i=j, t=f)
$allowed_symbols = "23456789acdegikpsvxyz"; #alphabet without similar symbols (o=0, 1=l, i=j, t=f)
...
$foreground_color = array(mt_rand(0,0), mt_rand(0,0), mt_rand(0,0));
$background_color = array(mt_rand(220,230), mt_rand(220,230), mt_rand(220,230));
